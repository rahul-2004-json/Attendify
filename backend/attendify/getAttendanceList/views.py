...
def fetch_students(request):
    ...
    student_list = [{"name": student['name'], "enrollment": student['enroll'], "batch": student["batch"], "branch": student["branch"], "year": student["year"], "encodings": student['encodings']} for student in students]
