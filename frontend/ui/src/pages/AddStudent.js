        ...
        <div className="min-h-screen p-6 mt-5">
          ...
          {showForm ? (
            <div className="flex flex-col p-4 mb-6 border rounded-md shadow-md shadow-indigo-300 max-w-md mx-auto">
              ...
              />
              {formErrors.name && (
                <p className="text-red-600 mb-2 -mt-2">{formErrors.name}</p>
              )}
              <input
                type="text"
                name="enroll"
              ...
              {formErrors.batch && (
                <p className="text-red-600 mb-2 -mt-2">{formErrors.batch}</p>
              )}
              <select
                name="year"
              ...
              >
                <FaFolderOpen className="mr-2" size={20} /> Upload Images
              </label>
              {formErrors.images && (
                <p className="text-red-600 mb-6 -mt-2">{formErrors.images}</p>
              )}{" "}
              {/* Error for images */}
              <button
                onClick={handleAdd}
            ...
            >
              <button onClick={handleAddStudent} className="text-indigo-600">
