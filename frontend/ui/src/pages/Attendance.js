...
const Attendance = () => {
	...
	const filterStudents = () => {
		...
		setPresentStudents(present.sort((a, b) => a.enrollment - b.enrollment));
		setAbsentStudents(absent.sort((a, b) => a.enrollment - b.enrollment));
	};
	...
	const moveToAbsent = (student) => {
		setPresentStudents(
			presentStudents
				.filter((s) => s.enrollment !== student.enrollment)
				.sort((a, b) => a.enrollment - b.enrollment)
		);
		setAbsentStudents(
			[...absentStudents, student].sort(
				(a, b) => a.enrollment - b.enrollment
			)
		);
	};
