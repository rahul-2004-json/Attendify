              ...
              forwardImages.map((image, index) => (
                ...
                >
                  <div className="relative">
                    ...
                    {/* Bounding boxes */}
                    {scales[index] &&
                      detectedFaces[index].face_locations.map((loc, i) => (
                        <div
                          key={i}
                          ...
                          style={{
                            ...
                            width: (loc[1] - loc[3]) * scales[index].scaleX,
                            height: (loc[2] - loc[0]) * scales[index].scaleY,
                          }}
                        ></div>
                      ))}
                  </div>
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    handleUpload(Array.from(e.target.files), retakeIndex)
                  }
                />
              </div>
            </div>
